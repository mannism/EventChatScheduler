            ...
            <Card className="glass-card overflow-hidden rounded-2xl border-0">
                <CardHeader className="flex flex-row items-center justify-between border-b border-black/10 dark:border-slate-800/60 bg-white/60 dark:bg-background/40 backdrop-blur-md p-6">
                    ...
                    <Button
                        ...
                        className="bg-gradient-to-r from-cyan-700 to-blue-600 hover:brightness-110 hover:scale-105 text-white shadow-lg px-6 py-6 rounded-xl transition-all font-sans border-0 focus-visible:ring-4 focus-visible:ring-cyan-500 min-h-[48px]"
                    >
